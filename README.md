...
running command...
$ solpilot (--version)
solpilot/1.2.1 linux-x64 node-v18.20.4
...
_See code: [src/commands/airdrop.ts](https://github.com/0xjesus/solpilot/blob/v1.2.1/src/commands/airdrop.ts)_
...
_See code: [src/commands/generate-keypair.ts](https://github.com/0xjesus/solpilot/blob/v1.2.1/src/commands/generate-keypair.ts)_
...
_See code: [src/commands/list-selected-wallet.ts](https://github.com/0xjesus/solpilot/blob/v1.2.1/src/commands/list-selected-wallet.ts)_
...
_See code: [src/commands/list-wallets.ts](https://github.com/0xjesus/solpilot/blob/v1.2.1/src/commands/list-wallets.ts)_
...
_See code: [src/commands/select-wallet.ts](https://github.com/0xjesus/solpilot/blob/v1.2.1/src/commands/select-wallet.ts)_
...
_See code: [src/commands/send.ts](https://github.com/0xjesus/solpilot/blob/v1.2.1/src/commands/send.ts)_
...
_See code: [src/commands/set-config.ts](https://github.com/0xjesus/solpilot/blob/v1.2.1/src/commands/set-config.ts)_
...
_See code: [src/commands/show-private-key.ts](https://github.com/0xjesus/solpilot/blob/v1.2.1/src/commands/show-private-key.ts)_
<!-- commandsstop -->
